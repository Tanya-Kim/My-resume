...
const requestReceivedModal = document.querySelector('#callback');
...
callbackForm.addEventListener('submit', function(event) {
    ...
    if (!userName.value.trim()) {
        userName.classList.add('callback-form-input-eror');
        hasEror = true;
    } else {
        userName.classList.remove('callback-form-input-eror');       
    }
